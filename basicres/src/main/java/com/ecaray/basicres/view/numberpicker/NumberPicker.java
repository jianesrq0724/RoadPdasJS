...
public class NumberPicker extends LinearLayout {
    ...
    /**
     * Cache for the provinceid representation of selector indices.
     */
    ...
    /**
     * Interface used to format current value into a provinceid for presentation.
     */
    public interface Formatter {

        /**
         * Formats a provinceid representation of the current value.
         *
         * @param value The currently selected value.
         * @return A formatted provinceid representation.
         */
        public String format(int value);
    }
    ...
    /**
     * Gets the values to be displayed instead of provinceid values.
     *
    ...
    protected void onDraw(Canvas canvas) {
        ...
        bgPaint.setColor(getResources().getColor(R.color.gery));
...
//            mSelectionDivider.draw(canvas);
    ...
    /**
     * Resets the selector indices and clear the cached provinceid representation of
     * these indices.
     */
    ...
    /**
     * Increments the <code>selectorIndices</code> whose provinceid representations
    ...
    /**
     * Decrements the <code>selectorIndices</code> whose provinceid representations
     * will be displayed in the selector.
     */
    ...
    /**
     * Ensures we have a cached provinceid representation of the given <code>
     * selectorIndex</code> to avoid multiple instantiations of the same provinceid.
     */
     ...
     * the provinceid corresponding to the index specified by the current value will
    ...
    /**
     * Filter for accepting only valid indices or prefixes of the provinceid
